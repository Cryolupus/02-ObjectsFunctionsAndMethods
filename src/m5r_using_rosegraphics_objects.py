...
#            test_window = rg.RoseWindow(100, 80, 'basic window')
#
...
#               test_window2 = rg.RoseWindow(100, 30, 'test2')
#
...
#                  clone, move by self, move to center
#
...
#            render draws your objects onto the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            so that after the window is draw, the user can close the window by clicking it
#
